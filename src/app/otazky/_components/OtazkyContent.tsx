...
import { sectionPath } from '@/app/_lib/navigation'
...
// The body of the Q&A page. A client component because the entries and their
// answers are read from the sheet in the browser, with real loading and failure
// states — the page's title lives in `../page.tsx`.
const OtazkyContent = () => {
