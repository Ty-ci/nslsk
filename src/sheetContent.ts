...
// redeploy.
//
// The types live here (and not next to the serverless function) because both
// sides need them: the Netlify function that reads the sheet imports them as
// types only, the React code imports the fetcher below.
...
/** Where the browser asks for the sheet content (see `netlify.toml`). */
