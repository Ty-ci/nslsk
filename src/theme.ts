// Flat spot-ink system for the poster look. Everything is drawn from three flat
// inks — near-black, terracotta and a rare forest green — the way a two-to-three
// colour riso job would. Class strings are spelled out in full so Tailwind
// detects them.
